...
function NotificationList({notifications, setNotifications} : any) {
  ...
  function handleAcceptFriendRequest(id) {
      ...
      fetch("http://127.0.0.1:5050/acceptFriendRequest", {
              method: "POST",
              crossDomain: true,
              headers: {
  ...
  function handleRejectFriendRequest(id) {
      fetch("http://127.0.0.1:5050/rejectFriendRequest", {
              method: "POST",
              crossDomain: true,
              headers: {
                  "Content-Type": "application/json",
  ...
  function handleAcceptEventInvite(id) {
      fetch("http://127.0.0.1:5050/acceptEventInvite", {
              method: "POST",
              crossDomain: true,
              headers: {
                  "Content-Type": "application/json",
  ...
  function handleRejectEventInvite(id) {
      fetch("http://127.0.0.1:5050/rejectEventInvite", {
              method: "POST",
              crossDomain: true,
              headers: {
                  "Content-Type": "application/json",
