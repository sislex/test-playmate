...
function ProfileBox({userData, own, friendStatus} : any) {
  const sendFriendRequest = (friendId: string) => {
    fetch("http://127.0.0.1:5050/sendFriendRequest", {
        method: "POST",
        crossDomain: true,
        headers: {
...
function Filters(props: any) {
  ...
  useEffect(() => {
    fetch("http://127.0.0.1:5050/getTeams", {
      method: "POST",
      crossDomain: true,
      headers: {
      "Content-Type": "application/json",
    ...
    fetch("http://127.0.0.1:5050/getSports", {
      method: "GET",
      crossDomain: true,
      headers: {
      "Content-Type": "application/json",
...
export function MyPlaymate() {
  ...
  useEffect(() => {
    ...
    let url = "http://127.0.0.1:5050/getUserData"
    if (id) {
      url += `/${id}`

      fetch("http://127.0.0.1:5050/getFriendStatus", {
        method: "POST",
        crossDomain: true,
        headers: {
          "Content-Type": "application/json",
  ...
  useEffect(() => {
    ...
    fetch("http://127.0.0.1:5050/getEvents", {
      method: "POST",
      crossDomain: true,
      headers: {
        "Content-Type": "application/json",
