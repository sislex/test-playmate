...
app.post("/register", async (req, res) => {                               // done
  ...
  try {
    ...
    const profilePics = ['http://127.0.0.1:5050/footballer1.jpg', 'http://127.0.0.1:5050/footballer2.jpg', 'http://127.0.0.1:5050/footballer3.jpg', 'http://127.0.0.1:5050/footballer4.jpg']
    ...
    if (user == "token expired") {
      ...
      file.mv(`${newpath}${filename}`, (err) => {
        if (err) {
          ...
          res.status(200).send({ message: "File Uploaded", data: "http://127.0.0.1:5050/profiles/"+filename, code: 200 });
        }
      });
    }
...
app.get("/forgot-password", async (req, res) => {
  ...
  try {
    ...
    console.log(token);
    const link = `http://127.0.0.1:5050/reset-password/${oldUser._id}/${token}`;
